...
const NewsList = ({ category }: { category: string }) => {
  ...
  return (
    <div>
      ...
      <div className="text-5xl font-bold text-center uppercase pb-10 text-[#ff0000]">{category}</div>
    {category === "home" && <HomePage />}
      <div className="grid grid-cols-2 gap-4 items-start justify-center px-20">
